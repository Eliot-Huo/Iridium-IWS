...
def create_default_customer_profile():
    ...
    return {
        "profile_id": "customer_2025H1",
        "profile_name": "2025年上半年客戶售價",
        "profile_type": "customer",
        "effective_date": "2025-01-07",
        "created_by": "system",
        "notes": "N3D 客戶售價（根據 SBD_Airtime_STD.pdf, 2025/1/7）",
        "plans": plans
    }
...
def create_default_iridium_cost_profile():
    ...
    return {
        "profile_id": "iridium_cost_2025H1",
        "profile_name": "2025年上半年 Iridium 成本價",
        "profile_type": "iridium_cost",
        "effective_date": "2025-06-23",
        "created_by": "system",
        "notes": "Iridium 官方成本價（Exhibit B-3.1 & B-3.3, Ver 23 June 2025）",
        "plans": plans
    }
...
def initialize_default_profiles():
    ...
    # 檢查是否已存在
    existing_customer = manager.get_profile_at_date('customer', datetime(2025, 1, 7).date())
